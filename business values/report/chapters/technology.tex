...
\begin{figure}[h]
    %\centering
    \includegraphics[width=17.5cm]{mock_up_green.png}
\end{figure}

\begin{figure}[h]
    %\centering
    \includegraphics[width=17.5cm]{mock_up_yellow.png}
\end{figure}

\begin{figure}[h]
    %\centering
    \includegraphics[width=17.5cm]{mock_up_yellow2.png}
\end{figure}

\begin{figure}[h]
    %\centering
    \includegraphics[width=17.5cm]{mock_up_red.png}
\end{figure}