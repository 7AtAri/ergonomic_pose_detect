...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{screen-green.png}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{mock_up_green.png}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{screen-yellow-mini_xai.png}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{screen-red-mini-xai.png}
\end{figure}
