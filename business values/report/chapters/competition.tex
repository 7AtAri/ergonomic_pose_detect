...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{zen.png}
    \caption{Zen logo}
...
Zen has a \textdollar9.99 yearly subscription if it’s the mobile version and \textdollar24.99 if it’s the desktop version. It targets consumers, companies as well as medical institutions such as hospitals and insurance companies. It advertises through paid online articles and paid partnerships with influencers on social media, but the ads are mainly focused on the mobile application.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{posture_ai.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{wearable_ai.png}
    \caption{smart t=shirt}
    \label{fig:enter-label1}
\end{figure}
Even though Posture AI launched 2 years ago and has 2 offices in Seoul \cite{postureai_linkedin} but the product is still in beta testing. It consists of a wearable t-shirt with a sensor that gets connected to a mobile application. The product is a one-time purchase at \textdollar149 and could be ordered online through their website \cite{myposture}. The company mainly targets consumers and has 2 investors but they are not publicly known \cite{postureai_pitchbook}. The Android mobile app only has 50+ downloads. 
